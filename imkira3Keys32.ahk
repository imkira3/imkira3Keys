...
A_Startup4 := "Loading mDesktop..."
A_Startup5 := "Loading RocketDock..."
A_Startup6 := "Hiding RocketDock..."
A_TooltipDelay := "1000"
A_TooltipX := "0"
A_TooltipY1 := "-20"
...
A_OGWindow := WinActive("A")
WinActivate "ahk_class" "Shell_TrayWnd"
ToolTip A_Startup4, A_TooltipX, A_TooltipY1
SetTimer () => ToolTip(), -A_TooltipDelay
try WinActivate A_OGWindow
...
A_OGWindow := WinActive("A")
WinActivate "ahk_class" "Shell_TrayWnd"
ToolTip A_Startup5, A_TooltipX, A_TooltipY1
SetTimer () => ToolTip(), -A_TooltipDelay
try WinActivate A_OGWindow
...
A_OGWindow := WinActive("A")
WinActivate "ahk_class" "Shell_TrayWnd"
ToolTip A_Startup6, A_TooltipX, A_TooltipY1
SetTimer () => ToolTip(), -A_TooltipDelay
try WinActivate A_OGWindow
sleep 1000
Send "^!{r}"
...
A_NumpadEnter := "Enter`rLeft Ctrl = Show/Hide Dock`rLeft Win = BossKey`rLeft Alt = Program 5 (Ctrl+Numpad5)"
...
A_Numpad1 := "Media Volume Down (Shift+Alt+Down)`rNumlock Off = Volume Down`rLeft Win = Send2Desk 1`rLeft Alt = F13`rCtrl+Left Win = DPI 1`rWin+Left Alt = DPI 11"
A_NumpadDown := "Cut`rNumlock On = Media Skip 2L (Ctrl+Shift+Left)`rLeft Alt = F14`rCtrl+Left Win = DPI 2`rWin+Left Alt = DPI 12"
A_Numpad2 := "Media Skip 2L (Ctrl+Shift+Left)`rNumlock Off = Cut`rLeft Win = Send2Desk 2`rLeft Alt = F14`rCtrl+Left Win = DPI 2`rWin+Left Alt = DPI 12"
